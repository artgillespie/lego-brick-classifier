Working with the family to build a "LEGO detector" that runs on a Raspberry Pi. Inspired by [Sorting Two Tons of Lego](https://jacquesmattheij.com/sorting-lego-the-software-side)
